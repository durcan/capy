...
class data(object):
    ...
    def __init__(self, detnum, min_date = 0 , max_date = numpy.inf, which_dataSet = 'ba', data_location = '/data3/cdmsbatsProd/R133/dataReleases/Prodv5-3_June2013/merged'):
        self.min_date = min_date
        self.max_date = max_date
        self.which_dataSet = which_dataSet
        self.data_location =  data_location
        self.detnum = detnum
        self.kwargs = {'detnum': detnum, 'min_date': min_date, 'max_date': max_date, 'which_dataSet': which_dataSet, 'data_location': data_location}
        self.loaded_rrqs = []
        self.loaded_rqs = []
        self.loaded_cuts = []
    ...
    def rrq(self, rrqs_to_load = [], eventRQ = False):
        ...
        return LoadFunction.LoadRRQ(**self.kwargs)
